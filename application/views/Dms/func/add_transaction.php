                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4"> <br>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input class="form-control form-control-sm" id="company_embid" value="" readonly />
                                  </div>
																	<div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm" id="company_address" readonly></textarea>
                                  </div>
                                  <div class="form-group">
                                    <label>Project Type:</label>
                                    <textarea class="form-control form-control-sm" id="project_type" readonly></textarea>
                                  </div>
                                  <div class="form-group">
                                    <label>Project Category:</label>
                                    <textarea class="form-control form-control-sm" id="project_category" readonly></textarea>
                                  </div>
                                ...
                                <div class="col-md-4"> <br>
																	...
																	<div id="asgnto_slctn">
																		<?php
																			if($credentials[0]['secno'] == 77 || $_SESSION['rec_officer'] == 'yes' || $_SESSION['superadmin_rights'] == 'yes' || $_SESSION['trans_regionalprc'] == 'yes') // RECORDS
																			{
																		?>
                                    ...
                                    <select id="personnel_id" class="form-control form-control-sm" name="receiver" >
                                      <option selected value="">--</option>
																	...
																	<div id="couriertype_div" class="form-group" style="display: none">
																		...
																		<select id="courier_type_slct" class="form-control form-control-sm" name="courier_type">
																			<option selected value="">--</option>
																			<?php
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control form-control-sm" name="remarks"><?php echo set_value('remarks'); ?></textarea>
                                  </div>
