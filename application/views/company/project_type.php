  ...
  <div class="container-fluid">
    ...
    $(document).ready(function () {
      var table = $('#company_lists').DataTable({
          ...
          "serverSide": true,
          "ajax":{
          "url": "<?php echo base_url('Company/Project_type/project_type_serverside') ?>",
          "dataType": "json",
          "type": "POST",
          ...
          "columns": [
            ...
            data = '<a href="<?php echo base_url('Company/Project_type/project_type_view?proid=') ?>'+row['proid']+'">' + data + '</a>';
            }
            return data;
            }
          },
          { "data": "numcompanies","searchable": true, "targets": 0,"orderable": true }
          ]
