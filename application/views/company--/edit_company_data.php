          ...
          <div class="row no-gutters align-items-center">
            ...
            <div class="branch_comp col-xl-12 mb-3">
              ...
              <div class="col-xl-12 mb-3">
                ...
                <input type="text" name="compname" value="<?php echo $company_data[0]['company_name']; ?>" class="form-control" placeholder="Enter Project name">
              </div>
            </div>
            ...
            <div class="col-xl-12 mb-3">
              ...
              <select class="form-control" name="project_type" id="comp_project_type_id" onchange='comp_project_type(this.value)'>
                <option value="">-</option>
                <?php foreach ($queryproject_type as $key => $qcat): ?>
                  <?php if ($qcat['proid'] == $company_data[0]['project_type']): ?>
                      <option value="<?php echo $qcat['proid'];?>" selected=''><?php echo $qcat['prj']; ?></option>
                  <?php endif; ?>
                      <option value="<?php echo $qcat['proid'];?>"><?php echo $qcat['prj']; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="col-xl-12 mb-3">
...
<div class="col-xl-12 mb-3">
  <button type="submit" class="btn btn-success btn-icon-split" style="float:right"><span class="text">UPDATE</span></button>
</div>
  </form>
