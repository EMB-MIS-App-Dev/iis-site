...
?>
				...
				<div class="col-xl-12 col-lg-12">
					<div class="trans-layout card shadow mb-4">
						...
						<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
							...
							<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-tasks"></i> DENR OFFICE - ALL TRANSACTIONS</h6>
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table id="denr_trans_table" class="table table-hover table-striped" width="100%" cellspacing="0">
									<thead>
										<tr>
											<th>no</th>
		...
		<script>
			...
			$(document).ready(function() {
			    ...
			    var table = $('#denr_trans_table').DataTable({
        			...
        			"scrollX": true,
			        ajax: {
			            "url": "<?php echo base_url('Dms/Datatables/denr_trans'); ?>",
			            "type": 'POST',
		    ...
		    // $("div.filter").on( 'click', '#filterbtn', function () {
			    ...
			    $('#denr_trans_table tbody').on( 'click', '#viewbtn', function () {
