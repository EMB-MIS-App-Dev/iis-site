          ...
          <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
              <div class="card-body">
                ...
                <hr>
                <?php echo form_open_multipart('Company/Add_company/add_company_index_sample','id="add_new_company_id"'); ?>
