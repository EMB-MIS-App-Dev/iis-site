			...
			<div class="col-xl-12 col-lg-12">
				<div class="trans-layout card shadow mb-4">
					...
					<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
						...
						<h6 class="m-0 font-weight-bold text-primary"> <i class="fas fa-share-square"></i> REVISE TRANSACTION</h6>

					</div>
					<?php $zxc = !empty($main_multi_cntr)?$main_multi_cntr:1; echo form_open_multipart('dms/documents/revise/'.$entry.'/'.$trans_no.'/'.$zxc.'/'.$multi_cntr, array('id' => 'dms_route_form')); ?>
						<!-- Card Body -->
						<div class="card-body">
												...
												<div class="row">
													...
													<div id="transaction-details-group" class="col-md-4"><br />
														<div class="form-group">
															<div class="row">
																<div class="col-sm-9 col-md-9 col-xs-12" style="margin: auto; margin-bottom: 0 !important">
																	<label>Transaction No.:</label>
																	<input class="form-control form-control-sm" value="<?php echo $trans_data[0]['token']; ?>" readonly />
																</div>
																<div class="col-sm-3 col-md-3 col-xs-12 image-container" style="text-align: center; margin: auto">
																	<figure style="margin-bottom: 0 !important">
																		<figcaption style="font-weight: bold;">QR Code</figcaption>
																		<input type="hidden" class="form-control" name="qr_code" value="<?=$qr_code_image?>" readonly>
																		<img style="border: 1px solid grey;" src="https://chart.googleapis.com/chart?chs=90x90&cht=qr&chld=Q|1&chl=https%3A%2F%2Fiis.emb.gov.ph/verify?token=<?=$qr_code_image?>%2F&choe=UTF-8" alt="qr-code">
																	</figure>
																</div>
															</div>
														</div>
						...
						<div class="card-footer">
							...
							<button id="reviseButton" type="submit" class="btn btn-danger btn-icon-split float-right" name="reviseTransaction"><span class="text"><i class="fas fa-share-square"></i> Revise</span></button><br /><br />
						</div>
