...
class Datatables extends CI_Controller
{
  ...
  function accomp_all()
  {
    ...
    if(!empty($filter['personnel'])) {
      $extraWhere .= '(ac.token = "'.$filter['personnel'].'") AND ';
    }
    ...
    if($this->session->userdata('universe_admin') == "yes") {
      ...
      switch ($univdata['user_func'][0]['func']) {
        ...
        default:
          if(in_array($univdata['user_cred']['userid'], array('51', '125', '111'))) {
              $extraWhere .= '1';
          }
          else {
