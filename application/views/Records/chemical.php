					...
					<div class="trans-layout card shadow mb-4">
						...
						<div class="card-body">
							...
							<div class="table-responsive" style="zoom: 90%">
								<table id="chemical_table" class="table table-hover table-striped" width="100%" cellspacing="0">
									<thead>
										<tr>
											<th>no</th>
	...
	<div hidden id="chemicaltype_selection">
		<select id="chemical_slctd" class="form-control" name="chemical_slct" >
			<?php
		...
		<script>
			...
			$(document).ready(function() {
				...
				$("div.type").html($('#chemicaltype_selection').html());

		    $('#chemical_table tbody').on( 'click', '#viewbtn', function () {
			        var data = table.row( $(this).parents('tr') ).data();
							Dms.view_transaction( data['trans_no'] );
				} );

				$('#chemical_slctd').change(function() {
          tableData.type = $('#chemical_slctd').val();
					table.draw();
				} );
