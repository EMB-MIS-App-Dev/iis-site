				...
				<div class="col-xl-12 col-lg-12">
					<div class="trans-layout card shadow mb-4">
						...
						<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
							...
							<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-tasks"></i> PUBLISHED DENR ADMINISTRATIVE ORDER</h6>
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table id="publish_dao_table" class="table table-hover table-striped" width="100%" cellspacing="0">
									<thead>
										<tr>
											<th>no</th>
		...
		<script>
			...
			$(document).ready(function() {
			    ...
			    var table = $('#publish_dao_table').DataTable({
        			...
        			"scrollX": true,
			        ajax: {
			            "url": "<?php echo base_url('Dms/Datatables/publish_dao'); ?>",
			            "type": 'POST',
			    ...
			    $('#publish_dao_table tbody').on( 'click', '#viewbtn', function () {
			        var data = table.row( $(this).parents('tr') ).data();
							Dms.view_transaction( data['trans_no'] );
				} );

				$('#publish_dao_table tbody').on( 'click', '#prcbtn', function () {
			        var data = table.row( $(this).parents('tr') ).data();
