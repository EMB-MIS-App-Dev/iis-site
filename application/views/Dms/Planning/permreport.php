				...
				<div class="col-xl-12 col-lg-12">
					<div class="trans-layout card shadow mb-4">
						...
						<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
							...
							<h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-tasks"></i> PLANNING - PERMITTING REPORT</h6>
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table id="planning_permreport_table" class="planning-table table table-hover table-striped" width="100%" cellspacing="0">
									<thead>
                    <tr>
                      <th colspan="5"></th>
                      ...
                      <th>Latitude</th>
                      <th>trans_no</th>
                      <th>IIS Transaction No.</th>
                      <th>Type of Permit</th>
                      <th>Permit No.</th>
                      <th>Status</th>
                      <th>Date Applied</th>
                      <th>Date Approved</th>
                      <th>Prescribed Days Of Processing</th>
											<th>Within the Prescribed Timeframe</th>
                      <th>Remarks (Interventions Made and Others)</th>
		...
		<script>
			...
			$(document).ready(function() {
		        ...
		        exportOptions: {
								...
								columns: [ 0,1,2,4,5,6,7,8,9,11,12,13,14,15,16,17,18,19 ],
		        }
			    };
			    var table = $('#planning_permreport_table').DataTable({
        			...
        			scrollX: true,
			        ajax: {
			            "url": "<?php echo base_url('Dms/Data_Tables/planning_permreport'); ?>",
			            "type": 'POST',
									"data": function ( d ) {
	          ...
	          tableData.end_date = '';
			    ...
			    $('#planning_permreport_table tbody').on( 'click', '#viewbtn', function () {
