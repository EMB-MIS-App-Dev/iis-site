...
<div class="container-fluid">
  <!-- <div class="alert alert-danger" role="alert" >
    <b>ATTENTION:</b> The Integrated Information System (IIS) - ADD COMPANY MODULE will undergo System update today, <b>August 28, 2020 at 6:30 p.m.</b>. Please close and finish all transactions before the said schedule to avoid data loss. Sorry for the inconvenience.
  </div> -->
</div>
  <div class="container-fluid">
      <div class="row">
              ...
              <div class="card-body">
                ...
                <!-- <form class="" action="<?php //echo base_url(); ?>/Company/Add_company/add_company" method="post" enctype="multipart/form-data"> -->
                  ...
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background: #ccc;">
                    <h6 class="m-0 font-weight-bold text-primary">REGISTERED COMPANIES  - <span style="color:red">Note: Please check if Company do not exist, if not proceed on adding a New Company. If exist, do not proceed to avoid duplication.</span>       Search here ... <button type="button" data-toggle='modal' data-target='#add_company_all_companies' class="btn " name="button"><i class="fas fa-eye"></i></button></h6>
                  </div>
                </div>
                <hr>
                <?php echo form_open_multipart('Company/Add_company/','id="add_new_company_id"'); ?>
                <!-- <input type="text" name="attachment_token" value="" id="attachment_token_id" > -->
                <?php if ($this->session->userdata('region') != 'CO'): ?>
                  <div class="col-xl-12">
                    <div class="row">
                        <div class="col-md-6">
                          <input type="radio" name="jurisdiction" value="1" onClick='jurisdiction_type(this)' checked>
                          <label for="">WITHIN JURISDICTION/REGION</label>
                        </div>
                        <div class="col-md-6">
                          <input type="radio" name="jurisdiction" value="2" onClick='jurisdiction_type(this)'>
                          <label for="">OUTSIDE JURISDICTION/REGION</label>
                        </div>
                    </div>
                  </div>
                <?php endif; ?>
                  <div class="col-xl-12  mb-4" style="padding:0!important">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background: #ccc;">
                      <h6 class="m-0 font-weight-bold text-primary">PROJECT INFORMATION (Company Information if not applicable)</h6>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                      ...
                                      <select class="form-control" name="main_comp" id="main_comp_id">
                                        <option value="">SELECT MAIN COMPANY - <span style="color:red">under development</span></option>
                                ...
                                <div class="row">
                                  <div class="col-xl-11">
                                    <div class="h6 mb-0 font-weight-bold text-gray-800">Main Company: <span class="error_req">( required )</div>
                                      <input readonly type="text" name="" value="" id="add_main_company_name" class="form-control project_name" placeholder="">
                                      <input type="hidden" name="main_comp" value="" id="add_main_company_id" class="form-control project_name" placeholder="">
                      <!-- <select class="form-control" name="main_comp" id="main_comp_id">
                  ...
                  <div class="col-xl-12  mb-4" style="padding:0!important">
                        ...
                        <div class="card-body">
                          <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-xl-12 mb-3">
                              ...
                              <input type="text" class="form-control form-control-user" placeholder="e.g. 55102" name="psi_code_no" value="">
                            </div>
                            <div class="col-xl-12 mb-3">
                              <div class="">Philippine Standard Industry Descriptor.</div>
                              <input type="text" class="form-control form-control-user" placeholder="e.g. 55102" name="psi_descriptor" value="">
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-12  mb-4" style="padding:0!important">
                        <!-- ADD NEW COMPANY -->
                      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background: #ccc;">
                        <h6 class="m-0 font-weight-bold text-primary">PROJECT ADDRESS</h6>
                      </div>
                        <div class="card shadow h-100 py-2" style="border-radius:0px!important">
                          <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                  ...
                                  <div class="col-xl-12">
                                    <div class="row">
                                      ...
                                      <?php if ($_SESSION['region'] == 'CO' || $_SESSION['userid'] == '1'): ?>
                                          ...
                                          <?php else: ?>
                                            <div class="col-xl-6" style="margin-bottom: 20px;display:none" id="outside_jurisdiction_region_container">
                                                <div class="add_comp_label">REGION: <span class="error_req">( required )</div>
                                                <select class="form-control" name="region_id"  onchange=select_region_1(this.value)>
                                                  <option value="">SELECT REGION</option>
                                                  <?php foreach ($region_data as $key => $rgnval): ?>
                                                    <?php if ($rgnval['rgnnum'] === 'CO'): ?>
                                                      <option value="<?php echo $rgnval['rgnnum']; ?>" style="display:none"><?php echo $rgnval['rgnnam']; ?></option>
                                    ...
                                    <div class="col-xl-4" id="in_jurisdiction_container_province">
                                    ...
                                    <div class="col-xl-4" id="outside_jurisdiction_container_province" style="display:none">
                                      <div class="add_comp_label">Province: <span class="error_req">( required )</div>
                                        <select name="" class="form-control" id="select_prov_sample" name="prov_id">
                                        <option value="" >--</option>
                                        </select>
                                        <div id="select_comp_province_id_outside"></div>
                                      <span class="error_req"><?php echo form_error('prov_id'); ?></span>
                                    </div>
                                    <div class="col-xl-4">
                        ...
                        <div class="row no-gutters align-items-center">
                          ...
                          <div class="col-xl-12 mb-3">
                            <div class="row">
                                <div class="col-xl-6">
                                  <div class="add_comp_label">Full Name</div>
                                  <input type="text" name="managing_head" value="<?php echo set_value('managing_head'); ?>" class="form-control">
                                </div>
                                <div class="col-xl-6">
                                  <div class="add_comp_label">Email:</div>
                                  <input type="text" name="managing_head_email" value="<?php echo set_value('managing_head_email'); ?>" class="form-control">
                                </div>
                            </div>
                          ...
                          <div class="col-xl-12 mb-3">
                            <div class="row">
                                <div class="col-xl-4">
                                  <div class="add_comp_label">Tel#:</div>
                                  <input type="text" name="managing_head_tel_no" value="<?php echo set_value('managing_head_tel_no'); ?>" class="form-control">
                                </div>
                                <div class="col-xl-4">
                                  <div class="add_comp_label">Fax #:</div>
                                  <input type="text" name="managing_head_fax_no" value="<?php echo set_value('managing_head_fax_no'); ?>" class="form-control">
                                </div>
                                <div class="col-xl-4">
                                  <div class="add_comp_label">Mobile No.::</div>
                                  <input type="text" name="managing_head_mobile_no" value="<?php echo set_value('managing_head_mobile_no'); ?>" class="form-control">
                                </div>
                            </div>
...
<div class="modal fade" id="add_company_all_companies" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" style="z-index:99999">
  <div class="modal-dialog modal-lg" role="document" style="max-width: 1000px!important;">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#018E7F;">
        <h7 class="modal-title" style="color:#FFF;" id="useraccountsModalLabel">All COMPANIES</h7>
...
<!-- for searching all companies -->
<script type="text/javascript">
  $(document).ready(function(){
  initDatatable1();
  });
  $('#sort_by_company_region').on('change',function(){
  initDatatable1($(this).val());
  })
  function initDatatable1(region){
    ...
    var table = $('#view_main_company_list').DataTable({
      ...
      "serverSide": true,
      "ajax": {
        "url": "<?php echo base_url(); ?>Company/Complist_server_side/all_company_list",
        "data": {
          "region": region
        }
      },
...
function initDatatable(region){
  ...
  var table = $('#add_main_company_list').DataTable({
    ...
    "serverSide": true,
    "ajax": {
      "url": "<?php echo base_url(); ?>Company/Complist_server_side/add_main_company_list",
      "data": {
        "region": region
      }
    },
    ...
    'columnDefs': [{
         ...
         'render': function (data, type, full, meta){
             ...
             return '<input type="checkbox" class="add_main_company_class" name="" value="'+data.company_id+'" onclick="add_main_company('+data.company_id+')">';
         }
      }],
      'order': [[1, 'asc']]
  });
