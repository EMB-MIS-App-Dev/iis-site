	...
	<script>
		$(document).ready(function() {
		    ...
		    var table = $('#inbox_table').DataTable({
						dom: "<'row'<'col-sm-12 col-md-2'l><'col-sm-12 col-md-6'><'col-sm-12 col-md-1'<'col_filter'>><'col-sm-12 col-md-2'<'search_bar'>><'col-sm-12 col-md-1'<'search_btn'>>>" +"<'row'<'col-sm-12'tr>>" +"<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
