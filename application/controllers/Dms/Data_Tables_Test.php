...
class Data_Tables_Test extends CI_Controller
{
  private $sql_details;
  private $dtdata;
  ...
  function all_transactions_test()
  {
    // Custom PHP includes
  ...
  function revisions() // from inbox
  {
    ...
    $columns = array(
        ...
        array( 'db' => 'vw.route_order', 'dt' => 'route_order', 'field' => 'route_order' ),
        array( 'db' => 'vw.main_multi_cntr', 'dt' => 'main_multi_cntr', 'field' => 'main_multi_cntr' ),
        array( 'db' => 'vw.multiprc', 'dt' => 'multiprc', 'field' => 'multiprc' ),
        array( 'db' => 'vw.multi_cntr', 'dt' => 'multi_cntr', 'field' => 'multi_cntr' ),
        array( 'db' => 'vw.company_name', 'dt' => 'company_name', 'field' => 'company_name', 'formatter' => function($d, $row) {
          return htmlspecialchars(stripslashes($d));
        } ),
        ...
        array( 'db' => 'vw.status_description', 'dt' => 'status_description', 'field' => 'status_description' ),
        array( 'db' => 'vw.action_taken', 'dt' => 'action_taken', 'field' => 'action_taken' ),
        array( 'db' => 'vw.sender_name', 'dt' => 'sender_name', 'field' => 'sender_name', 'formatter' => function($d, $row) {
          return (!empty($d)) ? $d : '--';
        } ),
        array( 'db' => 'vw.receiver_name', 'dt' => 'receiver_name', 'field' => 'receiver_name', 'formatter' => function($d, $row) {
          return (!empty($d)) ? $d : '--';
        } ),
        array( 'db' => 'vw.remarks', 'dt' => 'remarks', 'field' => 'remarks', 'formatter' => function($d, $row) {
          $sub = substr($d, 0, 60);
    ...
    $joinQuery = "FROM vw_dms_inbox_table5 vw JOIN er_transactions_log etl ON (etl.trans_no = vw.trans_no AND etl.route_order = vw.route_order AND etl.multi_cntr = vw.multi_cntr AND etl.main_multi_cntr = vw.main_multi_cntr AND (etl.sender_region = '".$user_region."' OR etl.receiver_region = '".$user_region."') )";
